    ...
    if (fbc_array != undefined) {
        ...
        if (style[0] == true) {
            ...
            for (var i = 0; i < bars; i++) {
                if (style[0] == true) {
                         if (style[2] == true) {
                    fill(((barColor[0]*16)+barColor[1]*1)*(1/(fbcmaximum/(fbc_array[i])))*(1/(fbcmaximum/(fbc_array[i]))*(1/(fbcmaximum/(fbc_array[i])))),((barColor[2]*16)+barColor[3]*1)*(1/(fbcmaximum/(fbc_array[i])))*(1/(fbcmaximum/(fbc_array[i]))*(1/(fbcmaximum/(fbc_array[i])))),((barColor[4]*16)+barColor[5]*1)*(1/(fbcmaximum/(fbc_array[i])))*(1/(fbcmaximum/(fbc_array[i])))*(1/(fbcmaximum/(fbc_array[i]))));
                }else{
